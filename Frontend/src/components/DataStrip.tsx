      ...
      <div ref={trackRef} className="flex items-center whitespace-nowrap">
        {items.map((f, i) => (
          <span key={i} className="flex items-center">
            <span className="font-syne text-[12px] text-text-muted uppercase">
              {f.name}
            </span>
            <span className="font-syne text-[12px] text-text-muted mx-1">
              · TER
            </span>
            <span className="font-mono text-[12px] text-negative font-medium">
              {f.ter}
            </span>
