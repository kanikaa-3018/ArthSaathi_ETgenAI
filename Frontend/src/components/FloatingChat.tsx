...
export function FloatingChat() {
  ...
  // Hide on /mentor page to avoid duplication
    ...
    <div className="fixed bottom-5 right-5 z-50">
      ...
      {widgetState === 'expanded' && (
        ...
        >
          ...
          >
            <p className="font-syne text-[13px] font-medium text-text-primary">Mentor</p>
            <div className="flex items-center gap-1">
              {/* Expand to full page */}
              <button
                onClick={() => { setWidgetState('collapsed'); navigate('/mentor'); }}
