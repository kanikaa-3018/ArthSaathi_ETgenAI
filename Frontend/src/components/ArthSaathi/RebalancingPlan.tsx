  ...
  lines.forEach((line, i) => {
    ...
    if (!trimmed) {
      ...
      rendered.push(
        <h3
          key={i}
          className="font-body text-lg font-bold text-primary-light mt-8 mb-3"
        >
          {trimmed.slice(3)}
        </h3>,
      );
      ...
      if (match) {
        rendered.push(
          <p
            key={i}
            className="font-body text-[15px] leading-relaxed mb-2"
      ...
      rendered.push(
        <p
          key={i}
          className="font-body text-xs italic flex items-start gap-2"
      ...
      rendered.push(
        <p
          ...
          style={{ color: "hsl(var(--text-secondary))", lineHeight: 1.75 }}
        >
          {trimmed}
        </p>,
      );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, hsl(var(--accent)), hsl(var(--positive)))",
        }}
      />
